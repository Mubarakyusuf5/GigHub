    ...
    <section className="text-center px-4 bg-heroPattern bg-center bg-opacity-5 pt-20 min-h-[90vh] bg-no-repeat bg-cover ">
      <div className="mb-10 max-w-3xl bg mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-7">
          <button className="bg-sky-400 hover:bg-sky-500  transition duration-300 text-white px-3 py-2.5 rounded-md font-medium">Post a Job</button>
          <button className="border border-gray-400 transition duration-300 hover:bg-gray-100 px-3 py-2.5 rounded-md font-medium" >Join as a Freelancer</button>
        </div>
