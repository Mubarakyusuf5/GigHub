...
export const DropdownMenu = ({ isOpen, setIsOpen, profile }) => {
  ...
  return (
    <div
      ...
      } w-[280px] rounded-xl border bg-white absolute right-[20px] lg:right-0 top-[60px] shadow-lg `}
    >
