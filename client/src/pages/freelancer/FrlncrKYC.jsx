...
export const FrlncrKYC =()=> {
  ...
  const steps = [
    ...
    { id: 2, name: "Work & Availability", icon: <BriefcaseIcon className="h-5 w-5" /> },
    { id: 3, name: "Portfolio & Links", icon: <LinkIcon className="h-5 w-5" /> },
    { id: 4, name: "Verification", icon: <ShieldCheckIcon className="h-5 w-5" /> },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-bold text-slate-900 sm:text-4xl">Complete Your Freelancer Profile</h1>
          <p className="mt-3 text-xl text-gray-500">Let's set up your profile to help you find the perfect projects</p>
        </div>
            ...
            {steps.map((s) => (
              <div
                ...
                className={`flex flex-col items-center ${
                  s.id < step ? "text-blue-600" : s.id === step ? "text-blue-600" : "text-gray-400"
                }`}
              >
                <div
                ...
                <span className="mt-2 text-sm font-medium hidden sm:block">{s.name}</span>
              </div>
            ))}
          </div>
          <div className="relative">
            ...
            <div className="relative flex justify-between">
              {steps.map((s) => (
                <div key={s.id}>
                  <div
                    className={`w-full h-1 ${s.id <= step ? "bg-blue-600" : "bg-gray-200"}`}
                    style={{
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-500 mt-1">
              ...
              {step === 2 && "Let clients know about your availability and rates"}
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="limited">Limited (10-20 hrs/week)</option>
                    <option value="occasional">Occasional (Less than 10 hrs/week)</option>
                  </select>
                </div>

                <div>
                  <label htmlFor="accntName" className="block text-sm font-medium text-gray-700 mb-1">
                    Account Name
                  </label>
                  <input
                    id="accntName"
                ...
                <div>
                  <label htmlFor="accntNumber" className="block text-sm font-medium text-gray-700 mb-1">
                    Account Name
                  </label>
                  <input
                    id="accntNumber"
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <h4 className="text-sm font-medium text-gray-500">Professional Title</h4>
                    ...
                    <div>
                      ...
                      <p className="mt-1">{formData.accntName ? `${formData.accntName}` : "Not provided"}</p>
                    </div>
                    
                    <div>
                      <h4 className="text-sm font-medium text-gray-500">Account Number</h4>
                      <p className="mt-1">{formData.accntNumber ? `${formData.accntNumber}` : "Not provided"}</p>
                    </div>
